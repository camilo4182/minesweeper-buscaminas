...
//----------------------------------------------------------------------------------------------------------------------------------------------------
	...
	*/
	 ...
	 *<b>Pre:</b> La matriz esta declarada e inicializada.<br>
	*/
	private void instalarMinas(){
		ArrayList<String> listaCoordenadas = new ArrayList<String>();
		...
		while(contador < cantidadMinas) {
			...
			coordenada = String.valueOf(i)+String.valueOf(j);
	...
	*/
	...
	/**
	 * Devuelve la cantidad de casillas que ya se han descubierto al hacer click sobre ellas.<br>
	 * 
	 * @return casillasDescubiertas - Cantidad de casillas descubiertas.
	 */
	public int casillasDescubiertas() {
		int casillasDescubiertas = 0;
		for(int i = 0; i < filas; i++) {
			for(int j = 0; j < columnas; j++) {
				if(!matriz[i][j].estaCubierta()) {
